  ...
  return (
    ...
    >
      <h2 className="font-serif">
        Hyer is a simple, straightforward app that connects
      </h2>{" "}
    </MovingText>
  );
};
function Slider() {
  return (
    <>
      ...
      >
        <SwiperSlide>
          <img className="w-full h-3/4 object-cover" src={img1} alt="" />
        </SwiperSlide>
        <SwiperSlide>
          <img className="w-full h-3/4 object-cover" src={img2} alt="" />
        </SwiperSlide>
        <SwiperSlide>
          <img className="w-full h-3/4 object-cover" src={img3} alt="" />
        </SwiperSlide>
        <SwiperSlide>
          <img className="w-full h-3/4  object-cover" src={img4} alt="" />
        </SwiperSlide>
      </Swiper>
    </>
  );
