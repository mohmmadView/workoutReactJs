...
var require_core2 = __commonJS({
  "node_modules/resolve/lib/core.js"(exports, module) {
    ...
    var path = require_path();
    var fs = require_fs();
    var data = JSON.parse(String(fs.readFileSync(path.join(path.dirname(__require.resolve("is-core-module/package.json")), "core.json"))));
    var core = {};
    for (mod in data) {
...
//# sourceMappingURL=chunk-AXN6JVPI.js.map
