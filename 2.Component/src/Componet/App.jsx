...
const App = () => {
  ...
  return (
    <div className="w-2/4 mx-auto">
      <p className="text-green-500 text-3xl p-3 text-center">
        {" "}
        <span className="text-yellow-400 text-2xl">it is {now.toString()}</span>
      </p>
      <Plus />
    </div>
  );
...
const Plus = () => {
  ...
  return (
    <p className="text-center mt-3 text-orange-300 pb-3">
      {a} <span className="text-rose-400"> plus </span> {b}{" "}
      <span className="text-rose-400"> is </span>
      {a + b}
    </p>
  );
};
