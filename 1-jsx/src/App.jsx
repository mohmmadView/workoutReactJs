...
<div className="w-3/4  bg-slate-700 p-8 border "><p className='text-justify mb-6'>JSX stands for JavaScript XML. It allows writing HTML in
 JavaScript and converts the HTML tags into React elements.
 <br/> <span className='text-yellow-600 font-bold text-2xl'> JSX </span> ( <span className='text-xl text-green-400'> JavaScript Extension</span> )<br/>
  is a React extension which allows writing JavaScript code that looks like HTML. In other words, JSX is an HTML-like syntax used by React that extends ECMAScript so that HTML-like syntax can co-exist with JavaScript/React code. The syntax is used by preprocessors (i.e., transpilers like babel) to transform HTML-like syntax into standard JavaScript objects that a JavaScript engine will parse.</p>
 ...
 <div className="mockup-code">
  ...
  <pre data-prefix="$" className=""><span className="token keyword text-purple-400">const</span> root <span className="token operator">=</span> ReactDOM<span className="token punctuation">.</span><span className="token function">createRoot</span><span className="token punctuation">(</span>document<span className="token punctuation">.</span><span className="token function">getElementById</span><span className="token punctuation">(</span><span className="token string">'root'</span><span className="token punctuation">)</span><span className="token punctuation">)</span><span className="token punctuation">;</span>

</pre> 
  <pre data-prefix=">" className="text-success"><code>root<span className="token punctuation">.</span><span className="token function">render</span><span className="token punctuation">(</span>myElement<span className="token punctuation">)</span><span className="token punctuation">;</span>
</code></pre>
</div>
...
<pre data-prefix=''><span>React.<span className='text-yellow-500'>createElement(</span><span className="text-green-500">"div"</span><span>,&nbsp;</span><span className="text-red-600">null</span><span>,&nbsp;</span><span className="text-green-500">"Hello&nbsp;JavaTpoint"</span><span>);&nbsp;&nbsp;</span></span>
</pre>
</div>
