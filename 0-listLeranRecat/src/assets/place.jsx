export default function Place({bgColor, Text}) {

return(
<svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 275 93" width="275" height="93">
  
  <defs>
    <style>{`.style-fonts{font-family: 'Cascadia', sans-serif;}`}</style>
