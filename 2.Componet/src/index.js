...
<Comment subject="Class Components" title="The functional component is also known as a stateless component because they do not hold or manage state. It can be explained in the below example." pre="import React, { Component } from 'react';  
