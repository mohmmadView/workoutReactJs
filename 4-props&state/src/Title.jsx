...
<h1 className='flex p-5 font-thin text-5xl mx-auto border rounded-lg mt-4  bg-gray-600 '>
{props.title}
<svg onClick={()=>{console.log("test")}} className="m-4 fill-red-100 cursor-pointer" viewBox="0 0 24 24" width="24" height="24" xmlns="http://www.w3.org/2000/svg">
  <defs></defs>
