...
*/}
        ...
        <div className="col">
          ...
          <Card2 {...callOuts[3]} />
          <Card2>
            <p className="bg-gray-700 p-2 mb-4 text-center font-bold text-2xl font-mono">
              class default props image & children{" "}
            </p>
          </Card2>
        ...
        <div className="mt-4 p-5 mx-32 mockup-code  bg-violet-300 text-primary-content">
          <code>
            <PrismGe code={code_Props_Type} language="javascript" />
          </code>
        </div>
        ...
        <div className="mt-4 p-5 mx-32   bg-violet-300 text-primary-content">
          <p className="text-2xl text-justify ">
            ...
            a button is clicked. To do this, add state to your component. First,
