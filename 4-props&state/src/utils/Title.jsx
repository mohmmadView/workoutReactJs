...
<h1 className='flex max-sm:text-3xl max-sm:leading-[1.750] max-sm:p-1 p-5 font-thin text-5xl mx-auto my-auto border rounded-lg mt-4  bg-gray-600 '>
{props.title}
<svg onClick={()=>{let UrlCard = props.code ; }} className="m-4 fill-red-100 cursor-pointer" viewBox="0 0 24 24" width="24" height="24" xmlns="http://www.w3.org/2000/svg">
  <defs></defs>
