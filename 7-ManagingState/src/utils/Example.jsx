...
<h1 className="p-3 mb-2 bg-primary-content text-3xl text-primary font-normal border rounded-lg ring-1 inline  after:bg-white "> {props.exampleNumber} : <span className='text-orange-400'>{props.exampleName}</span></h1>
</section>
